...
export const accessUrl = `${authEndpoint}?client_id=${process.env.clientId}&redirect_uri=${redirectUri}&client_secret=${process.env.clientSecret}&scope=${scopes.join(' ')}&response_type=token&show_dialog=true`;
