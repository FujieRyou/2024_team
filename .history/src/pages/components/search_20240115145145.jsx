...
const handleAddTrack = async (track) => {
    ...
    const result = await addTrackToPlaylist(token, playlistId, trackId);
    if (result.status === 201) {
      // 追加成功
        setSearchResults(searchResults.filter((s) => s.id !== track.id));
    } else {
      // 追加失敗
    }
};
...
return (
    <div>
        ...
        <div>
            ...
            <div key={track.id} className='searchResults' onClick={()=>{handleAddTrack(track)}}>
