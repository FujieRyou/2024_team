...
// NEXT_PUBLIC_CLIENT_ID = "0a3e36eee74549849ad025c8cf1c4a2e"
const clientSecret = 'ae260ea0439b41f4869d0b4759694580'
// SPOTIFY_REDIRECT_URI = 'http://localhost:3000/api/hello'
...
export const accessUrl = `${authEndpoint}?client_id=${process.env.NEXT_PUBLIC_CLIENT_ID}&redirect_uri=${redirectUri}&scope=${scopes.join(' ')}&response_type=token&show_dialog=true`;
